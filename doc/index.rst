...
You can use simplicial topology to model any number of things: approximations of curved
surfaces, point-cloud data, the relationships between elements of a dataset, constraints
on solutions to a problem, and so forth. Once you've modelled a problem in this way, you
...
* Represents finite closed simplicial complexes, with a lot of checking to ensure that
  that they stay legal as simplices are added and removed (a common source of errors)
...
* Performs homology computations, computes Euler characteristics, does Euler characteristic
  integration, and other interesting operations
