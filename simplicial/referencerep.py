...
class ReferenceRepresentation(Representation):
    ...
    def newSimplex(self,  fs: List[Simplex]) -> str:
        ...
        given faces. The default naming scheme uses a sequence number
        and a leading dimension indicator. Users can name simplices
        anything they want to get meaningful names.
        ...
        """
        i = self._sequence
        k = 0 if fs is None or len(fs) == 0 else len(fs) - 1
        while True:
            id = f'{k}d{i}'
    ...
    def addSimplex(self, fs: List[Simplex] = None, id: Simplex = None, attr: Attributes = None) -> Simplex:
        ...
        of fs. This manipulates several internal data structures
    ...
    def forceDeleteSimplex(self, s: Simplex):
        """Delete a simplex without sanity checks. It deletes the simplex,
        ...
        # because this method is always called form the highest orders
        # down, any appearance opf this simplex in the boundary matrix
        # of the order above should be a line of zeros, as any
        # simplices of which it is a face should already have been
        # deleted
